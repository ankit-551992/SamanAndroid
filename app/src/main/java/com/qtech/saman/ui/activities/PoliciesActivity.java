...
public class PoliciesActivity extends BaseActivity {
    ...
    String termsAr = "<p> شروط الخدمة </ p> \n" +
            "           <p> &nbsp; </ p>\n" +
            "           <p> نظرة عامة </ p>\n" +
            "           <p> &nbsp; </ p>\n" +
            "           <p> يتم تشغيل تطبيق الجوّال هذا بواسطة saman. في جميع أنحاء التطبيق ، تشير البنود &ldquo;، &ldquo; &ldquo;، &ldquo;&ldquo; & &ldquo; لدينا &ldquo; إلى saman. تقدم saman هذا التطبيق ، بما في ذلك جميع المعلومات والأدوات والخدمات المتوفرة من هذا الموقع لك ، المستخدم ، مشروط بموافقتك على جميع البنود والشروط والسياسات والإشعارات الواردة هنا. </ p> \n" +
            "           <p> &nbsp; </ p>\n" +
            "           <p> من خلال زيارة تطبيقنا للجوّال و / أو شراء شيء ما منا ، فإنك تشترك في خدمة &ldquo; الخدمة &ldquo; وتوافق على الالتزام بالبنود والشروط التالية (&ldquo; بنود الخدمة &ldquo;، &ldquo; الشروط &ldquo;) ، بما في ذلك تلك الشروط والأحكام الإضافية والسياسات المشار إليها هنا و / أو المتاحة من خلال الارتباط التشعبي ، وتنطبق شروط الخدمة هذه على جميع مستخدمي الموقع ، بما في ذلك على سبيل المثال لا الحصر المستخدمين الذين هم المتصفحات ، والبائعين ، والعملاء ، والتجار ، و / أو المساهمين في المحتوى. </ p> \"\n" +
            "           <p> &nbsp; </ p>\n" +
            "           <p> يرجى قراءة شروط الخدمة هذه بعناية قبل الدخول إلى أو استخدام تطبيقنا. عن طريق الوصول إلى أو استخدام أي جزء من التطبيق ، فإنك توافق على الالتزام بشروط الخدمة هذه. إذا كنت لا توافق على جميع الشروط والأحكام من هذه الاتفاقية ، لا يجوز لك الوصول إلى تطبيق الجوال &nbsp; أو استخدام أي من الخدمات. إذا كانت \"شروط الخدمة\" هذه تعتبر عرضًا ، فإن القبول يقتصر صراحةً على شروط الخدمة هذه. </ p> \"\n" +
            "           <p> &nbsp; </ p>\n" +
            "           <p> تخضع أي ميزات أو أدوات جديدة تضاف إلى المتجر الحالي أيضًا لشروط الخدمة. يمكنك مراجعة أحدث إصدار من شروط الخدمة في أي وقت في هذه الصفحة. ونحن نحتفظ بالحق في تحديث أو تغيير أو استبدال أي جزء من شروط الخدمة هذه عن طريق نشر تحديثات و / أو تغييرات على طلبنا ، وتقع على عاتقك مسؤولية التحقق من هذه الصفحة بشكل دوري من أجل التغييرات ، واستخدامك المستمر أو الوصول إلى التطبيق بعد نشر أي تغييرات يشكل قبولًا لهذه التغييرات. </ p> \"\n" +
            "           <p> &nbsp; </ p>\n" +
            "           <p> تتم استضافة متجرنا على &hellip; & &hellip; .. وهو يزودنا بمنصة التجارة الإلكترونية عبر الإنترنت التي تتيح لنا بيع منتجاتنا وخدماتنا إليك. </ p>\n" +
            "           <p> &nbsp; </ p>\n" +
            "           <p> القسم 1 - شروط المتجر عبر الإنترنت </ p>\n" +
            "           <p> &nbsp; </ p>\n" +
            "           <p> بالموافقة على شروط الخدمة هذه ، فإنك تقر بأن عمرك أقلية في منطقتك على الأقل ، أو أنك في سن الرشد في منطقتك وأعطيتنا موافقتك على السماح لأي من المعالين الطفيفة لاستخدام هذا التطبيق </ p> \"\n" +
            "           <p> &nbsp; </ p>\n" +
            "           <p> لا يجوز لك استخدام منتجاتنا لأي غرض غير قانوني أو غير مصرح به ولا يجوز لك ، في استخدام الخدمة ، انتهاك أي قوانين في نطاق سلطتك (بما في ذلك على سبيل المثال لا الحصر قوانين حقوق الطبع والنشر). </ p>\n" +
            "           <p> &nbsp; </ p>\n" +
            "           <p> يجب عدم نقل أي فيروسات أو فيروسات أو أي رمز ذي طبيعة تدميرية. </ p>\n" +
            "           <p> &nbsp; </ p>\n" +
            "           <p> سيؤدي أي خرق أو انتهاك لأي من البنود إلى الإنهاء الفوري لخدماتك. </ p>\n" +
            "           <p> &nbsp; </ p>\n" +
    ...
    String privacyAr = "<p> Saman شروط الخدمة </ p>\n" +
            "           <p> &nbsp; </ p>\n" +
            "           <p> نظرة عامة </ p>\n" +
            "           <p> &nbsp; </ p>\n" +
            "           <p> يتم تشغيل تطبيق الجوّال هذا بواسطة saman. في جميع أنحاء التطبيق ، تشير البنود &ldquo;، &ldquo; &ldquo;، &ldquo; &ldquo;&ldquo; لدينا &ldquo; إلى saman. تقدم saman هذا التطبيق ، بما في ذلك جميع المعلومات والأدوات والخدمات المتوفرة من هذا الموقع لك ، المستخدم ، مشروط بموافقتك على جميع البنود والشروط والسياسات والإشعارات الواردة هنا. </ p>\n" +
    ...
    String returnAr = "<p> شروط الخدمة </ p>\n" +
            "           <p> &nbsp; </ p>\n" +
            "           <p> نظرة عامة </ p>\n" +
            "           <p> &nbsp; </ p>\n" +
            "           <p> يتم تشغيل تطبيق الجوّال هذا بواسطة saman. في جميع أنحاء التطبيق ، تشير البنود & ldquo ، & ldquo & ldquo ، & ldquo & ldquo & ldquo لدينا & rdquo إلى saman. تقدم saman هذا التطبيق ، بما في ذلك جميع المعلومات والأدوات والخدمات المتوفرة من هذا الموقع لك ، المستخدم ، مشروط بموافقتك على جميع البنود والشروط والسياسات والإشعارات الواردة هنا. </ p>\n" +
            "           <p> &nbsp; </ p>\n" +
            "           <p> من خلال زيارة تطبيقنا للجوّال و / أو شراء شيء ما منا ، فإنك تشترك في خدمة & ldquo الخدمة & rdquo وتوافق على الالتزام بالبنود والشروط التالية (& ldquo بنود الخدمة & rdquo ، & ldquo الشروط & rdquo) ، بما في ذلك تلك الشروط والأحكام الإضافية والسياسات المشار إليها هنا و / أو المتاحة من خلال الارتباط التشعبي ، وتنطبق شروط الخدمة هذه على جميع مستخدمي الموقع ، بما في ذلك على سبيل المثال لا الحصر المستخدمين الذين هم المتصفحات ، والبائعين ، والعملاء ، والتجار ، و / أو المساهمين في المحتوى. </ p>\n" +
            "           <p> &nbsp; </ p>\n" +
            "           <p> يرجى قراءة شروط الخدمة هذه بعناية قبل الدخول إلى أو استخدام تطبيقنا. عن طريق الوصول إلى أو استخدام أي جزء من التطبيق ، فإنك توافق على الالتزام بشروط الخدمة هذه. إذا كنت لا توافق على جميع الشروط والأحكام من هذه الاتفاقية ، لا يجوز لك الوصول إلى تطبيق الجوال &nbsp; أو استخدام أي من الخدمات. إذا كانت \"شروط الخدمة\" هذه تعتبر عرضًا ، فإن القبول يقتصر صراحةً على شروط الخدمة هذه. </ p>\n" +
